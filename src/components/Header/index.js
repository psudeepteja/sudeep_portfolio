...
export default function Header() {
    return (
        <div className='px-4 md:px-12 py-1 flex items-center w-full shadow-md  sticky bg-white z-10 inset-x-0 top-0 mb-4 dark:bg-gray-950 dark:text-[#fff]'>
            <div className="w-3/4 md:w-1/2 flex items-center">
                ...
                <img src='/sudeep_logo.png' alt='sudeep_logo' height="124px" width="124px"/>
            </div>
