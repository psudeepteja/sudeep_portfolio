...
export default function Footer() {
    return (
        <>
            <div className="px-4 py-6 md:px-4 md:py-6 border-t dark:border-t-gray-800 flex flex-col md:flex-row gap-2 md:gap-8 items-center">
            ...
            <div className='text-center text-sm text-gray-700 pb-4 dark:text-[#fff]'>Copyright © {new Date().getFullYear()} Sudeep Teja.</div>
        </>
    )
}
