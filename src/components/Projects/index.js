    ...
    return (
        ...
        {webPages.map((item, index) => (
          <a
            ...
            className="block bg-white dark:bg-gray-950 rounded-xl shadow-lg inset-shadow-[#FF6464] hover:shadow-lg transition-transform transform hover:scale-105 overflow-hidden border"
          >
            <img
              src={item.img}
              alt={item.title}
